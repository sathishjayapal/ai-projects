  ...
  return (<>
    ...
    <div className="md:w-2/5 mb-12">
      ...
      <div className="flex flex-col border border-gray-300 rounded">
        <Link to="/lookupUserQuestionss" className="w-full border-gray-300 hover:bg-gray-100 border-b rounded-t px-4 py-2">{t('lookupUserQuestions.list.headline')}</Link>
        <Link to="/docDBDatas" className="w-full border-gray-300 hover:bg-gray-100 rounded-b px-4 py-2">{t('docDBData.list.headline')}</Link>
      </div>
    </div>
  </>);
}
