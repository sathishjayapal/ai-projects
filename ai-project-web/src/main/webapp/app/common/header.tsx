            ...
            <ul className="flex">
              ...
              <li className="relative">
                ...
                <ul className="hidden block absolute right-0 bg-white border border-gray-300 rounded min-w-[10rem] py-2" aria-labelledby="navbarEntitiesLink">
                  <li><Link to="/lookupUserQuestionss" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('lookupUserQuestions.list.headline')}</Link></li>
                  <li><Link to="/docDBDatas" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('docDBData.list.headline')}</Link></li>
                </ul>
              </li>
            </ul>
          </div>
