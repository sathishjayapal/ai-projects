...
```
java -Dspring.profiles.active=production -jar ./ai-project-web/target/ai-project-web-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=me.sathish/ai-project
```
